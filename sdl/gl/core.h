...
public:
	...
	void f_matrix2(bool a_transpose, const GLfloat* a_values, GLsizei a_count = 1)
	{
		glUniformMatrix2fv(v_id, a_count, a_transpose ? GL_TRUE : GL_FALSE, a_values);
		f_check();
	}
	void f_matrix3(bool a_transpose, const GLfloat* a_values, GLsizei a_count = 1)
	{
		glUniformMatrix3fv(v_id, a_count, a_transpose ? GL_TRUE : GL_FALSE, a_values);
		f_check();
	}
	void f_matrix4(bool a_transpose, const GLfloat* a_values, GLsizei a_count = 1)
	{
		glUniformMatrix4fv(v_id, a_count, a_transpose ? GL_TRUE : GL_FALSE, a_values);
		f_check();
	}
};
